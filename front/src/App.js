  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/login" element={loggedInUser ? <Navigate to="/" /> : <Login onLogin={(user) => {setLoggedInUser(user); console.log(loggedInUser);}} />}/>
        ...
        <Route path ="google-callback" onEnter={() => {console.log('')}} element={<GoogleCallback onLogin={handleLogin}/>}/>
        ...
        <Route path="/offers/:id" element={<OfferDetails loggedInUser={!!loggedInUser} />} />
      </Routes>
    </Router>
  );
}
